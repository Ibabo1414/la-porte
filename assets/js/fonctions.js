...
//**************** Soumission du formulaire après la saisie ***************************
let colorbButton = document.querySelector('button');

let back = document.querySelector('form');

let typeColor = "#a7ff3342";

colorbButton.addEventListener('click', changeColor);
...
function changeColor() {
    ...
    if ((inputEmail = true) && (inputPassword = true)) {
        //- L’adresse e-mail est correctement saisie;
        back.style.backgroundColor = typeColor;
    } 
}
